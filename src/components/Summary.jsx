...
export default function Summary() {
  return (
    <div className="space-y-7">
      <article data-reveal className="reveal soft-card relative overflow-hidden rounded-3xl bg-white p-7 md:p-10">
        ...
        <h2 className="relative mt-3 text-3xl font-black tracking-tight text-academic-deep-rose md:text-4xl">Suy ngẫm sau hành trình học tập</h2>
        <p className="relative mt-6 whitespace-pre-line text-justify leading-8 text-academic-muted">
...
Việc làm portfolio bằng web cũng giúp em luyện thêm kỹ năng trình bày sản phẩm số: sắp xếp bố cục, chia nội dung, gắn link báo cáo và làm sao để người xem dễ theo dõi."`}
      ...
      <div className="grid gap-7 md:grid-cols-2">
        <article data-reveal className="reveal soft-card hover-lift rounded-2xl bg-white p-7">
          ...
          <h3 className="mt-3 text-xl font-black">Khó khăn gặp phải</h3>
        ...
        <article data-reveal className="reveal soft-card hover-lift rounded-2xl bg-white p-7">
          ...
          <h3 className="mt-3 text-xl font-black">Kế hoạch hoàn thiện</h3>
          <p className="mt-4 text-justify text-sm leading-7 text-academic-muted">
            Sau khi hoàn thành web, em sẽ kiểm tra lại toàn bộ link báo cáo PDF để chắc chắn các file mở được đúng bài. Với những bài không có sản phẩm riêng, em sẽ ghi rõ ràng sản phẩm và minh chứng đã được trình bày trong báo cáo, không tạo thêm link hoặc nội dung không có thật. Em cũng sẽ kiểm tra bản PDF xuất từ portfolio để đảm bảo nội dung không bị thiếu khi nộp lên hệ thống.
          </p>
        </article>
      </div>

      <article data-reveal className="reveal rounded-3xl border border-academic-border bg-academic-blush p-7 text-center md:p-10">
        <h3 className="text-xl font-black text-academic-ink">Cam kết Liêm chính Học thuật</h3>
        <p className="mx-auto mt-4 max-w-3xl whitespace-pre-line text-sm italic leading-7 text-academic-muted">
          {`Em, Trần Bảo Nhi, cam kết các báo cáo và nội dung trong portfolio này phản ánh quá trình học tập và thực hành của bản thân. Em có sử dụng AI như một công cụ hỗ trợ, chủ yếu để gợi ý cách trình bày, sửa code và kiểm tra nội dung.
